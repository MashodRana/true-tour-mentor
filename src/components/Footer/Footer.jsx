            ...
            <div className="container mx-auto grid md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <nav class="list-none mb-10">
                        <li>
                            <a class="text-gray-600 hover:text-gray-800">Tour Plans</a>
                        </li>
                        <li>
                            <a class="text-gray-600 hover:text-gray-800">Hotel Bookings</a>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <nav class="list-none mb-10">
                        ...
                        <li>
                            <a class="text-gray-600 hover:text-gray-800"><i class="fas fa-phone"></i>&nbsp;01777777777</a>
                        </li>
                        <li>
            ...
            <div class="bg-gray-100">
                <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p class="text-gray-500 text-sm text-center sm:text-left">© 2021 True Tour Mentor —
                        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@MashodRana</a>
                    </p>
